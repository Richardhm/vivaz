<ul style="list-style:none;margin:0;padding:0;" class="w-100" id="list_user_historico">
    @php $iix = 0;@endphp
    @foreach($users as $uu)
        @php $iix++;@endphp
        <li class="d-flex justify-content-between text-white w-100 py-1 {{ $iix % 2 == 0 ? 'user_destaque_impar' : '' }}" data-user="{{$uu->user_id}}">
