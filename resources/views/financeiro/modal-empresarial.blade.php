...
{{--                    <input type="text" id="plano_contratado" value="{{$texto_empresarial}}" readonly class="w-full mudar_empresarial bg-gray-100 text-sm text-gray-800 p-1 rounded-md">--}}
            ...
            <div class="grid grid-cols-4 gap-4 mb-2">
                <div>
                    ...
                    <input type="text" id="valor_saude" value="{{number_format($valor_saude,2,",",".")}}" readonly class="w-full mudar_empresarial bg-gray-100 text-sm  text-gray-800 p-1 rounded-md">
                </div>
                <div>
                    ...
                    <input type="text" id="valor_odonto" value="{{number_format($valor_odonto,2,",",".")}}" readonly class="w-full mudar_empresarial bg-gray-100 text-sm  text-gray-800 p-1 rounded-md">
                </div>
                <div>
                    ...
                    <input type="text" id="total_plano" value="{{number_format($valor_total,2,",",".")}}" readonly class="w-full bg-gray-100 mudar_empresarial text-sm text-gray-800 p-1 rounded-md">
                </div>
                <div>
                    ...
                    <input type="text" id="taxa_adesao" value="{{number_format($taxa_adesao,2,",",".")}}" readonly class="w-full bg-gray-100 text-sm mudar_empresarial text-gray-800 p-1 rounded-md">
                </div>
            </div>
            ...
            <div class="grid grid-cols-4 gap-4 mb-2">
                <div>
                    ...
                    <input type="text" id="plano_adesao" value="{{number_format($valor_total,2,",",".")}}" readonly class="w-full bg-gray-100 text-sm text-gray-800 p-1 rounded-md">
                </div>
                <div>
                    ...
                    <input type="text" id="valor_boleto" value="{{number_format($valor_boleto,2,",",".")}}" readonly class="w-full mudar_empresarial bg-gray-100 text-sm  text-gray-800 p-1 rounded-md">
                </div>
                <div>
