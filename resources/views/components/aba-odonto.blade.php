    ...
    <section class="flex justify-between flex-wrap content-start">
        ...
        <div class="flex flex-col text-white basis-[16%] rounded-lg">
            <div class="flex mb-1 justify-between">
                <span class="bg-[rgba(254,254,254,0.18)] hover:cursor-pointer backdrop-blur-[15px] text-white text-sm py-2 text-center rounded w-full">
                    <a class="text-center text-white create_odonto">Cadastrar</a>
                </span>
            </div>
